...
set trace_all_name "./NDP_trace_all_[lindex $argv 0].ta";
set nam_file "./NDP_nam_[lindex $argv 0].nam";
...
$ns simplex-link $nqueue $nclient $lineRate [expr $RTT/4] NDP_PriQueue
$ns simplex-link $nclient $nqueue $lineRate [expr $RTT/4] NDP_PriQueue
